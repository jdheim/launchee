...
func TestConfigPathStub(t *testing.T) {
	testCases := map[string]struct {
		...
		"invalid": {ConfigPathInvalidStub{}, []string{"/usr/bin/echo", "/usr/bin/echo"}},
		"valid":   {ConfigPathValidStub{}, []string{"../../test/stub/stub_config/launchee-7.yml", "../../test/stub/stub_config/launchee-override.yml"}},
	}
