...
func TestUnmarshalConfigs(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"valid":             {stub.ConfigPathValidStub{}, true},
		"invalid":           {stub.ConfigPathInvalidStub{}, false},
		"system invalid":    {stub.SystemConfigPathInvalidStub{}, false},
		"user invalid":      {stub.UserConfigPathInvalidStub{}, false},
		"not exists":        {stub.ConfigPathNotExistsStub{}, true},
		"system not exists": {stub.SystemConfigPathNotExistsStub{}, true},
		"user not exists":   {stub.UserConfigPathNotExistsStub{}, true},
	}
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			...
			if got := err == nil; got != testCase.want {
				t.Errorf("UnmarshalConfigs() = %t, want %t", got, testCase.want)
			}
		})
	}
}
